...
# External 40 MHz clock for TTC
create_clock -period 25.000 -name fmc_l8_clk0 [get_ports fmc_l8_clk0]
...
set_clock_groups -asynchronous -group [get_clocks -include_generated_clocks fmc_l8_clk0]
