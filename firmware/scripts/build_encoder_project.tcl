...
# Create project
create_project FC7_Encoder $origin_dir/project/encoder

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects FC7_Encoder]
...
add_files -norecurse -fileset $obj [glob $origin_dir/ip/encoder/*/*.xci]
...
foreach file [glob $origin_dir/ip/encoder/*/*.xci] {
...
set obj [get_filesets sources_1]
set_property "top" "fc7_encoder_top" $obj
...
foreach file_temp [glob $origin_dir/constraints/common/*.xdc $origin_dir/constraints/encoder/*.xdc] {
...
set_property "steps.write_bitstream.tcl.post" "[file normalize "$origin_dir/scripts/export_encoder_bitstream.tcl"]" $obj

# set the current impl run
current_run -implementation [get_runs impl_1]

puts "INFO: Project created: FC7_Encoder"
