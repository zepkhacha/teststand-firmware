...
# Create project
create_project FC7_Trigger $origin_dir/project/trigger

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects FC7_Trigger]
...
add_files -norecurse -fileset $obj [glob $origin_dir/ip/trigger/*/*.xci]
...
foreach file [glob $origin_dir/ip/trigger/*/*.xci] {
...
set obj [get_filesets sources_1]
set_property "top" "fc7_trigger_top" $obj
...
foreach file_temp [glob $origin_dir/constraints/common/*.xdc $origin_dir/constraints/trigger/*.xdc] {
...
#  create_run -name synth_1 -part xc7k420tffg1156-2 -flow {Vivado Synthesis 2014} -strategy "Flow_PerfOptimized_High" -constrset constrs_1
  create_run -name synth_1 -part xc7k420tffg1156-2 -flow {Vivado Synthesis 2018} -constrset constrs_1
} else {
#  set_property strategy "Flow_PerfOptimized_High" [get_runs synth_1]
  set_property flow "Vivado Synthesis 2018" [get_runs synth_1]
}
set_property STEPS.SYNTH_DESIGN.ARGS.BUFG 24 [get_runs synth_1]
...
#  create_run -name impl_1 -part xc7k420tffg1156-2 -flow {Vivado Implementation 2014} -strategy "Performance_Explore" -constrset constrs_1 -parent_run synth_1
...
set_property "steps.write_bitstream.tcl.post" "[file normalize "$origin_dir/scripts/export_trigger_bitstream.tcl"]" $obj
...
puts "INFO: Project created: FC7_Trigger"
